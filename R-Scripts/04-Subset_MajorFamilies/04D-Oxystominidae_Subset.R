...
asvTable_Subset <- subset(ASV_Taxonomy, select = c(nem27,nem194,nem280,nem22,nem41,nem52,nem55,nem157,nem172,nem215,nem229,nem233,nem237,nem240,nem243,nem246,nem258,nem271,nem286,nem288,nem116,nem76,nem81,nem19,nem25,nem33,nem37,nem238,nem242))
...
write.table(asvTable_Subset_RelativeAbundance_RemoveLowAbundance_Separate_Taxonomy_Long, "Oxystominidae/DADA2_BiomTable_Oxystominidae_Family_Sans_LowAbundance_LONG_FORMAT.tsv", 
...
write.table(asvTable_Subset_removeBLANKasvs, file='Final_BiomTable_Oxystominidae_DADA2.tsv', quote=FALSE, sep='\t', col.names = NA)
